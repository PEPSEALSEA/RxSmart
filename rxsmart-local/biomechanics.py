...
UPPER_JOINT_LIMITS: Dict[str, Dict[str, dict]] = {
    "l_arm_upper": {
        "elevation": {"min": 0, "max": 180, "rest": 8, "maxVelocity": 60, "idealVelocityMin": 12, "idealVelocityMax": 48, "tolerance": 12},
    ...
    "l_leg_upper": {
        "elevation": {"min": 0, "max": 130, "rest": 0, "maxVelocity": 48, "idealVelocityMin": 10, "idealVelocityMax": 38, "tolerance": 10},
...
LOWER_JOINT_LIMITS: Dict[str, Dict[str, dict]] = {
    "l_arm_lower": {
        "bend": {"min": 0, "max": 145, "rest": 6, "maxVelocity": 75, "idealVelocityMin": 14, "idealVelocityMax": 52, "tolerance": 8},
    },
    "r_arm_lower": {
        "bend": {"min": 0, "max": 145, "rest": 6, "maxVelocity": 75, "idealVelocityMin": 14, "idealVelocityMax": 52, "tolerance": 8},
    },
    "l_leg_lower": {
        "bend": {"min": 0, "max": 135, "rest": 0, "maxVelocity": 55, "idealVelocityMin": 12, "idealVelocityMax": 40, "tolerance": 8},
    },
    "r_leg_lower": {
        "bend": {"min": 0, "max": 135, "rest": 0, "maxVelocity": 55, "idealVelocityMin": 12, "idealVelocityMax": 40, "tolerance": 8},
    },
